...
export const Bio = {
  ...
  export const experiences = [
    {
      id: 0,
      img: cbatesicon,
      role: "Content Wrting and Data Analyst Intern",
      company: "Cbates (Communities Building Attitudes To Encourage Success)",
      date: "June 2022 - Sep 2022",
      desc: "Produced impactful content to support social services for marginalized communities. Developed insightful data visualizations to complement analytical findings.",
      skills: [
        "Tableau",
        "MS Word",
        "MS Excel",
  ...
  export const projects = [
    ...
    },
    {
      ...
      description:
        "Developed a full-stack web application using Next.js that emulates the functionalities and visual aesthetics of Twitter.",
      image:
        tweeter,
    ...
    },
    {
      ...
      description:
        "Conducted a comprehensive data analysis project using R to explore obesity trends in the United States.",
      image:
        obesity,
      tags: [
        "React Js",
    ...
    },
    {
      ...
      description:
        "Conducted a hate crime data analysis project using Python and pandas to uncover insights and patterns of Hate crime within the United States.",
      image:
        hateCrimes,
